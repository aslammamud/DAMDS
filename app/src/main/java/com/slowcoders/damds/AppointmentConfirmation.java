...
public class AppointmentConfirmation extends AppCompatActivity {
    long maxid = 0;
    private TextView serialConfText, timeConfText, dateConfText, nameConfText, ageConfText, genderConfText, bloodgroupConfText, symptomsConfText, phoneConfText, doctornameConfText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef = FirebaseDatabase.getInstance().getReference("Appointments").child(Date);
        ...
        confirmAppointment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AppointmentItem DataItem = new AppointmentItem(PatientName, Age, Gender, Bloodgroup, Symptoms, Phone, Date, Time, Doctorname, Doctorid);
