...
public class DoctorsListGovt extends AppCompatActivity {
    private Button goBackDoctorsList;
    private RecyclerView recyclerView;
    private com.slowcoders.damds.DoctorsListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference("DepartmentsGovt").child(value);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new com.slowcoders.damds.DoctorsListAdapter(getApplicationContext(), items);
