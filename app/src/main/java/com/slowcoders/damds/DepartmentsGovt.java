...
public class DepartmentsGovt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        department_names_array = getResources().getStringArray(R.array.govt_hostpital_departments_array);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(DepartmentsGovt.this, DoctorsListGovt.class);
